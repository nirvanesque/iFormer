...
def iFormer_m(pretrained=False, in_22k=False, init_cfg=None, out_indices=[], **kwargs):
    depths = [2, 2, 22, 6]
    block_types = ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 9 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wsp1', 'FFN2d_r3'] + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1', 'FFN2d_r3'] * 2 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wre1', 'FFN2d_r3'] + ['ConvBlock_k7_r4'] + \
    ...
    model = iFormer(depths=depths, dims=[48, 96, 192, 384], use_bn=True, conv_stem_type='FusedIB',
                     ...
                     block_types=block_types, init_cfg=init_cfg, pretrained=pretrained, out_indices=out_indices)
    return model


# using fused_attn 4.0ms
@MODELS.register_module()
def iFormer_m_faster(pretrained=False, in_22k=False, init_cfg=None, out_indices=[], **kwargs):
    depths = [2, 2, 22, 6]
    block_types = ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 9 + \
...
# 14.7M  2627M 1.60ms
@MODELS.register_module()
def iFormer_l(pretrained=False, in_22k=False, init_cfg=None, out_indices=[], **kwargs):
    depths = [2, 2, 33, 6]
    block_types = ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 8 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wsp1', 'FFN2d_r3'] * 1 +\
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1', 'FFN2d_r3'] * 5 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wre1', 'FFN2d_r3'] * 1 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1', 'FFN2d_r3'] * 1 + ['ConvBlock_k7_r4'] + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr4_act0_nh1', 'FFN2d_r3'] * 2
...
@MODELS.register_module()
def iFormer_l_faster(pretrained=False, in_22k=False, init_cfg=None, out_indices=[], **kwargs):
    depths = [2, 2, 33, 6]
    block_types = ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 8 + \
...
# 24.5M   4500M  9.06ms
@MODELS.register_module()
def iFormer_l2(pretrained=False, in_22k=False, init_cfg=None, out_indices=[], **kwargs):
    depths = [3, 3, 46, 9]
    block_types = ['ConvBlock_k7_r4'] * 3 + ['ConvBlock_k7_r4'] * 3 + ['ConvBlock_k7_r4'] * 12 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wsp1', 'FFN2d_r3'] * 1 +\
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1', 'FFN2d_r3'] * 8 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1_ws16_wre1', 'FFN2d_r3'] * 1 + \
                  ['RepCPE_k3', 'SHMABlock_r1_hdrr2_act0_nh1', 'FFN2d_r3'] * 1 + ['ConvBlock_k7_r4'] + \
