...
def get_args_parser():
    parser = argparse.ArgumentParser('iFormer training and evaluation script for image classification', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='iFormer_t', type=str, metavar='MODEL',
    ...
    parser.add_argument('--project', default='iformer', type=str,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('iFormer training and evaluation script', parents=[get_args_parser()])
